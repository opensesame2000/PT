...
/**
 * Record the information to the LogCat of the console, display the calling method and
 * the file and line number where it is located, which is convenient for debugging and debugging during development.
 * Note: Open in the Debug state, close in the Release state, sensitive information should not
 * be printed, otherwise it will be harmed by illegal people.
 */
public final class LogUtils {
    ...
    private static String debugTag = "Rajk";// LogCat tag
    ...
    /**
     * Record information at the "verbose" level     *
     * @param tag the tag
     * @param msg the msg
     */
    ...
    /**
     * Call the build .trace file in a method. Then get the computer and open the analysis with the DDMS tool.     *
     ...
     * <p>
     * See this method：https://github.com/Ereza/CustomActivityOnCrash
     *
